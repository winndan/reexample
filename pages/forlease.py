...
def forleasepage(page=1):
    listings, total = get_paginated_listings("for_lease", page=page, per_page=PER_PAGE)
    ...
    Head(
        *GoogleAnalytics("G-6NGE48T3KE"),
        ...
        Title('Properties For Lease - Luxe Properties'),
        Meta(name='description', content='Browse luxury properties for lease and rent. Find your ideal home or office space.'),
        Link(rel='preconnect', href='https://fonts.googleapis.com'),
        Link(rel='preconnect', href='https://fonts.gstatic.com', crossorigin=''),
        Link(href='https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap', rel='stylesheet'),
        Link(rel='stylesheet', href='styles/components/navbar.css'),
        Link(rel='stylesheet', href='styles/components/footer.css'),
        Link(rel='stylesheet', href='styles/static/forlease.css')
    ),
    Body(
        Navbar(active="forlease"),
        Section(
            Div(
                Div(
                    A('Home', href='/'),
                ...
                H1('Properties For Lease', cls='page-title'),
                P('Find your ideal rental property from our premium selection', cls='page-subtitle'),
                cls='container'
            ),
            cls='page-header'
        ),
        Main(
            Div(
                    ...
                    Form(
                        ...
                        Div(
                            ...
                            Select(
                                ...
                                Option('Office Space', value='office'),
                        ...
                        Div(
                            Label('Monthly Rent', cls='filter-label'),
                            Div(
                                Input(type='number', placeholder='Min Rent', id='minPrice', cls='filter-input'),
                                Span('-', cls='price-separator'),
                                Input(type='number', placeholder='Max Rent', id='maxPrice', cls='filter-input'),
                                cls='price-inputs'
                            ),
                            cls='filter-group'
                        ),
                        ...
                        Div(
                            Label('Furnishing', cls='filter-label'),
                            Select(
                                Option('Any', value=''),
                                Option('Fully Furnished', value='fully'),
                                Option('Semi-Furnished', value='semi'),
                                Option('Unfurnished', value='unfurnished'),
                                id='furnishing', cls='filter-select'
                            ),
                            cls='filter-group'
                        ),
                        Div(
                            Label('Lease Term', cls='filter-label'),
                            Select(
                                Option('Any Term', value=''),
                                Option('Short Term (< 6 months)', value='short'),
                                Option('1 Year', value='1year'),
                                Option('2 Years', value='2year'),
                                Option('Long Term (3+ years)', value='long'),
                                id='leaseTerm', cls='filter-select'
                            ),
                            cls='filter-group'
                        ),
                        Div(
                ...
                Div(
                    Div(
                        ...
                        Div(
                            ...
                            Select(
                                ...
                                Option('Rent: Low to High', value='price-low'),
                                Option('Rent: High to Low', value='price-high'),
                    ...
                    Div(
                        *[_lease_card(l) for l in listings],
                        id='propertyGrid', cls='property-grid'
                    ),
                    _pagination_nav(page, total_pages, '/for-lease'),
                    cls='listings-main'
                ),
        ...
        Script(src='styles/static/forlease.js', defer=True),
...
def _lease_card(l):
    ...
    title = l.get('title', '')
    price = l.get('price', '')
    price_label = l.get('price_label', '/ month')
    ...
    furnishing = l.get('furnishing', 'Unfurnished')
    featured = l.get('featured', False)

    badges = []
    if featured:
        badges.append(Span('Featured', cls='badge badge-featured'))
    badges.append(Span('For Lease', cls='badge badge-lease'))
    ...
    return Article(
        ...
        Div(
            Div(Span(furnishing, cls='furnishing-tag'), cls='furnishing-info'),
